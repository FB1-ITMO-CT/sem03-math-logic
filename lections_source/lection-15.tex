...
задаёт \emph{эрбранову интерперетацию}.
\end{dfn}
...
\begin{dfn}Система основных примеров --- все основные примеры, опровергаемые хоть при какой-то эрбрановой интерпертации $\mathcal{M}$:
