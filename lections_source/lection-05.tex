...
\only<1>{$$\forall x.E(s (x),z)~\vee~G (p(q(s (x)),o), o)$$}
\only<2>{$$\forall x.{\color{blue}E}(s (x),z)~\vee~{\color{blue}G} (p(q(s (x)),o), o)$$}
\only<3>{$${\color{blue}\forall} x.{\color{blue}E}(s (x),z) {\color{blue}~\vee~} {\color{blue}G} (p(q(s (x)),o), o)$$}
\only<4>{$${\color{blue}\forall} {\color{red}x}.{\color{blue}E}(s ({\color{red}x}),z) {\color{blue}~\vee~} {\color{blue}G} 
   (p(q(s ({\color{red}x})),o),o)$$}
\only<5>{$${\color{blue}\forall} {\color{red}x}.{\color{blue}E}({\color{red}s} ({\color{red}x}),{\color{red}z}) {\color{blue}~\vee~} {\color{blue}G} 
